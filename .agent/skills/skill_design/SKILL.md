...
10. **Preset Browser:** Top bar? Sidebar? Dropdown? (see Preset Browser section below)
...
## 🎛️ PRESET BROWSER DESIGN PATTERNS

Every plugin should include a preset browser. Choose a layout:

### Option A: Top Bar (Most Common)
```
┌─────────────────────────────────────────────┐
│ ◀ │ "Warm Glow"  │ ▶ │ 💾 │ Category ▾  │
├─────────────────────────────────────────────┤
│                                             │
│           Main Plugin Controls              │
│                                             │
└─────────────────────────────────────────────┘
```

### Option B: Sidebar (For Large Libraries)
```
┌──────────┬──────────────────────────────────┐
│ Presets  │                                  │
│          │     Main Plugin Controls         │
...
See `skill_presets/SKILL.md` for implementation.
...
7. **Include preset browser** - Every professional plugin needs preset management
